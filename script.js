...
document.querySelectorAll('.featured-card, .collection-card, .why-item, .mission-card, .contact-info-card, .stats-section').forEach(el => {
 ...
 */
const cards = document.querySelectorAll('.featured-card, .collection-card, .mission-card, .why-item');
...
document.querySelectorAll('img').forEach(img => {
    img.addEventListener('error', function() {
        this.src = 'data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22200%22 height=%22200%22%3E%3Crect fill=%22%23ccc%22 width=%22200%22 height=%22200%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%22.3em%22 fill=%22%23999%22%3EImage Not Found%3C/text%3E%3C/svg%3E';
